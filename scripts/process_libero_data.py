...
def process_task_dataset(task_no, source_h5_path, dest_h5_path, benchmark, env_factory):
    ...
    # Enable force-torque observables in the underlying robosuite environment
    env.env.modify_observable(observable_name="robot0_eef_force", attribute="active", modifier=True)
    env.env.modify_observable(observable_name="robot0_eef_torque", attribute="active", modifier=True)
